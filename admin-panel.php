...
<html>
  ...
  <body style="border-radius:0;background:url('illustration-fitness-equipments-design-background_916191-36203.avif');>
      
   
       
 <div class="jumbotron" style="border-radius:0;background:url('');background-size:cover;height:200px;"></div>
